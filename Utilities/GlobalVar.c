...
float		g_LoadRelayOpenVoltage[4]     = { 46.0,46.0,46.0,46.0}; 			//主负载继电器开路电压    (第1路)		46	
float		g_LoadRelayCloseVoltage[4]    = { 48.0,48.0,48.0,48.0}; 			//主负载继电器闭合电压    (第1路)		48	


int			g_LoadDiscWaitingTime								= 5;						//单位分钟
...
struct_Result2				g_Result2,g_Result3;
PVT6_ParaInfo					g_PVTPara;
//----------------------------------------------------
struct_Rectifier    			g_Rectifier;
