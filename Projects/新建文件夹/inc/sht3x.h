...
typedef union {
  ...
  struct{
    ...
    unsigned short int AlertPending  : 1;
    unsigned short int Reserve3      : 1;
    unsigned short int HeaterStatus  : 1;
    unsigned short int Reserve2      : 1;
    unsigned short int RH_Alert      : 1;
    unsigned short int T_Alert       : 1;
    unsigned short int Reserve1      : 5;
    unsigned short int ResetDetected : 1;
    unsigned short int Reserve0      : 2;
    unsigned short int CmdStatus     : 1;
    unsigned short int CrcStatus     : 1;
    #endif
  }bit;
} regStatus;
...
//-----------------------------------------------------------------------------
void SHT3X_Init(unsigned char i2cAddress);
