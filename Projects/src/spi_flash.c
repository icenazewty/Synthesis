...
#define BLE         0xD8  /* Block(64K) Erase instruction */
...
{ 	
    ...
    spi_init_struct.clock_polarity_phase = SPI_CK_PL_HIGH_PH_2EDGE;		//SPI_CK_PL_HIGH_PH_2EDGE;	//SPI_CK_PL_LOW_PH_1EDGE;
...
uint16_t SPI_FLASH_SendHalfWord(uint16_t HalfWord)
{
  ...
  spi_i2s_data_transmit(SPI1, HalfWord);
